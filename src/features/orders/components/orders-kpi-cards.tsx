    ...
    <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4' aria-busy={loading}>
      ...
      <Card className='border-slate-200/80 shadow-sm dark:border-slate-800'>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <IconFileText className='h-4 w-4 text-slate-500' aria-hidden='true' />
        </CardHeader>
        <CardContent>
          <div className='text-2xl font-bold text-slate-900 dark:text-slate-50'>
            {loading ? (
              <span
                className='inline-block h-8 w-12 bg-slate-200 dark:bg-slate-700 rounded animate-pulse'
                aria-hidden='true'
              />
            ) : (
              (stats?.total ?? '—')
      ...
      <Card className='border-slate-200/80 shadow-sm dark:border-slate-800'>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <IconClock className='h-4 w-4 text-blue-500' aria-hidden='true' />
        </CardHeader>
        <CardContent>
          <div className='text-2xl font-bold text-blue-600 dark:text-blue-400'>
            {loading ? (
              <span
                className='inline-block h-8 w-12 bg-blue-100 dark:bg-blue-950/50 rounded animate-pulse'
                aria-hidden='true'
              />
            ) : (
              (stats?.pending ?? '—')
      ...
      <Card className='border-slate-200/80 shadow-sm dark:border-slate-800'>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <IconCircleCheck className='h-4 w-4 text-emerald-500' aria-hidden='true' />
        </CardHeader>
        <CardContent>
          <div className='text-2xl font-bold text-emerald-600 dark:text-emerald-400'>
            {loading ? (
              <span
                className='inline-block h-8 w-12 bg-emerald-100 dark:bg-emerald-950/50 rounded animate-pulse'
                aria-hidden='true'
              />
            ) : (
              (assignedAndTransit ?? '—')
      ...
      <Card className='border-slate-200/80 shadow-sm dark:border-slate-800'>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <IconAlertTriangle className='h-4 w-4 text-rose-500' aria-hidden='true' />
        </CardHeader>
        <CardContent>
          <div className='text-2xl font-bold text-rose-600 dark:text-rose-400'>
            {loading ? (
              <span
                className='inline-block h-8 w-12 bg-rose-100 dark:bg-rose-950/50 rounded animate-pulse'
                aria-hidden='true'
              />
            ) : (
              (stats?.noVehicle ?? '—')
